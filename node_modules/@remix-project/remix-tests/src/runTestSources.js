...
class UnitTestRunner {
    ...
    runTestSources(contractSources, compilerConfig, testCallback, resultCallback, deployCb, finalCallback, importFileCb, opts) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            opts = opts || {};
            const sourceASTs = {};
            const web3 = opts.web3 || (yield this.createWeb3Provider());
            ...
            async_1.default.waterfall([
                ...
                (next) => {
                    (0, compiler_1.compileContractSources)(contractSources, compilerConfig, importFileCb, { accounts, testFilePath: opts.testFilePath, event: this.event }, next);
                },
                function deployAllContracts(compilationResult, asts, next) {
                    ...
                    (0, deployer_1.deployAll)(compilationResult, web3, false, deployCb, (err, contracts) => {
                        if (err) {
                            ...
                            if (err.message.includes('The contract code couldn\'t be stored, please check your gas limit')) {
                                (0, deployer_1.deployAll)(compilationResult, web3, true, deployCb, (error, contracts) => {
                                    if (error)
